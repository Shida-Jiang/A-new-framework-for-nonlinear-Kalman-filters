...
clc
clear
repeat=10000; %The number of backout_freqs that the simulation is repeated at each measurement noise setup
%This simulation takes about 30 minutes, you can reduce the repeat backout_freqs to reduce the run backout_freq
%%
noise1_ref=1;
noise2_ref=1;
...
for i=scale
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(0,noise1,repeat,0.5);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(1,noise1,repeat,0.5);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(1,noise1,repeat,0);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(0,noise1,repeat,0);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(0,noise1,repeat,3);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(1,noise1,repeat,3);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(0,noise1,repeat,3.5);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(1,noise1,repeat,3.5);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(0,noise1,repeat,1);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(1,noise1,repeat,1);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(0,noise1,repeat,2);
    ...
    [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(1,noise1,repeat,2);
...
leg=legend([h1_1 h2_1 h3_1 h4_1], 'Location','southeast','NumColumns',1,FontSize=11);
title(leg,'Line colors')
grid on
exportgraphics(f1,'Synchronous-Generator_no_backout.png','Resolution',900)
...
set(gca, 'XTick', [0.000001 0.00001 0.0001 0.001 0.01 0.1]);
leg=legend([h1_2 h2_2 h3_2 h4_2], 'Location','southeast','NumColumns',1,FontSize=11);
grid on

exportgraphics(f3,'generator_backout_freq.png','Resolution',900)

function [x1_rmse,x2_rmse,x3_rmse,x4_rmse,backout_freq]=simulation(backout,noise1,repeat,KFtype)
%% Problem setup
improvement1=1;
delta_t=1e-4;
w0=2*60*pi;
        ...
        if(KFtype==0)
            ...
            if(improvement1==1)
                ...
                if(sum(diag(temp))<sum(diag(Variance)) || backout==0)
                    ...
                    states=states0;
                    backout_freq=backout_freq+1/repeat/stepnum;
                end
            else
