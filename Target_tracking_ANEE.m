...
for i=scale
    magnitude=10^i;
    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(0,magnitude,repeat,0);
    len=length(x_RMSE(1,:));
    ...
    ANEES_EKF_1=[ANEES_EKF_1 ANEES];
    ANEES_ideal_EKF_1=[ANEES_ideal_EKF_1 ANEES_ideal];
    NCI_EKF_1=[NCI_EKF_1 NCI];
    if i==i0
        x_EKF_1=x_RMSE(1,:);
        y_EKF_1=x_RMSE(4,:);
    end

    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(1,magnitude,repeat,0);
    ...
    ANEES_EKF_2=[ANEES_EKF_2 ANEES];
    ANEES_ideal_EKF_2=[ANEES_ideal_EKF_2 ANEES_ideal];
    NCI_EKF_2=[NCI_EKF_2 NCI];
    if i==i0
        x_EKF_2=x_RMSE(1,:);
        y_EKF_2=x_RMSE(4,:);
    end

    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(0,magnitude,repeat,0.5);
    ...
    ANEES_IEKF_1=[ANEES_IEKF_1 ANEES];
    ANEES_ideal_IEKF_1=[ANEES_ideal_IEKF_1 ANEES_ideal];
    NCI_IEKF_1=[NCI_IEKF_1 NCI];
    if i==i0
        x_IEKF_1=x_RMSE(1,:);
        y_IEKF_1=x_RMSE(4,:);
    end
    ...
    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(0,magnitude,repeat,3);
    ...
    ANEES_EKF2_1=[ANEES_EKF2_1 ANEES];
    ANEES_ideal_EKF2_1=[ANEES_ideal_EKF2_1 ANEES_ideal];
    NCI_EKF2_1=[NCI_EKF2_1 NCI];
    if i==i0
        x_EKF2_1=x_RMSE(1,:);
        y_EKF2_1=x_RMSE(4,:);
    end

    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(1,magnitude,repeat,3);
    ...
    ANEES_EKF2_2=[ANEES_EKF2_2 ANEES];
    ANEES_ideal_EKF2_2=[ANEES_ideal_EKF2_2 ANEES_ideal];
    NCI_EKF2_2=[NCI_EKF2_2 NCI];
    if i==i0
        x_EKF2_2=x_RMSE(1,:);
        y_EKF2_2=x_RMSE(4,:);
    end
    ...
    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(0,magnitude,repeat,1);
    ...
    ANEES_UKF_1=[ANEES_UKF_1 ANEES];
    ANEES_ideal_UKF_1=[ANEES_ideal_UKF_1 ANEES_ideal];
    NCI_UKF_1=[NCI_UKF_1 NCI];
    if i==i0
        x_UKF_1=x_RMSE(1,:);
        y_UKF_1=x_RMSE(4,:);
    end

    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(1,magnitude,repeat,1);
    ...
    ANEES_UKF_2=[ANEES_UKF_2 ANEES];
    ANEES_ideal_UKF_2=[ANEES_ideal_UKF_2 ANEES_ideal];
    NCI_UKF_2=[NCI_UKF_2 NCI];
    if i==i0
        x_UKF_2=x_RMSE(1,:);
        y_UKF_2=x_RMSE(4,:);
    end

    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(0,magnitude,repeat,2);
    ...
    ANEES_CKF_1=[ANEES_CKF_1 ANEES];
    ANEES_ideal_CKF_1=[ANEES_ideal_CKF_1 ANEES_ideal];
    NCI_CKF_1=[NCI_CKF_1 NCI];
    if i==i0
        x_CKF_1=x_RMSE(1,:);
        y_CKF_1=x_RMSE(4,:);
    end

    [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est,ANEES,NCI,ANEES_ideal] = simulation(1,magnitude,repeat,2);
    ...
    ANEES_CKF_2=[ANEES_CKF_2 ANEES];
    ANEES_ideal_CKF_2=[ANEES_ideal_CKF_2 ANEES_ideal];
    NCI_CKF_2=[NCI_CKF_2 NCI];
    if i==i0
        x_CKF_2=x_RMSE(1,:);
        y_CKF_2=x_RMSE(4,:);
    end
...
%%
f2=figure('Position',[100 100 500 450]);
t=tiledlayout(2,1,'TileSpacing','Compact','Padding','Compact');
nexttile
hold on
%title("ANEES", 'FontWeight', 'normal')
h1_2=plot(10.^scale, ANEES_EKF_2, '-o', 'DisplayName', "EKF", 'Color', '#0072BD','LineWidth',1);
h1_1=plot(10.^scale, ANEES_EKF_1, '--o', 'DisplayName', "EKF", 'Color', '#0072BD','LineWidth',1);
h2_2=plot(10.^scale, ANEES_EKF2_2, '-s', 'DisplayName', "EKF2", 'Color', "#D95319",'LineWidth',1);
h2_1=plot(10.^scale, ANEES_EKF2_1, '--s', 'DisplayName', "EKF2", 'Color', "#D95319",'LineWidth',1);
h3_2=plot(10.^scale, ANEES_UKF_2, '-^', 'DisplayName', "UKF", 'Color', "#EDB120",'LineWidth',1);
h3_1=plot(10.^scale, ANEES_UKF_1, '--^', 'DisplayName', "UKF", 'Color', "#EDB120",'LineWidth',1);
h4_2=plot(10.^scale, ANEES_CKF_2, '-x', 'DisplayName', "CKF", 'Color', "#7E2F8E",'LineWidth',1);
h4_1=plot(10.^scale, ANEES_CKF_1, '--x', 'DisplayName', "CKF", 'Color', "#7E2F8E",'LineWidth',1);
h5_1=plot(10.^scale, ANEES_IEKF_1, '--d', 'DisplayName', "IEKF", 'Color', "#4DBEEE",'LineWidth',1);
set(gca, 'XScale', 'log', 'YScale', 'log', 'XTickLabel', [],'FontSize', 12)
%xlabel('Measurement noise (per unit)',FontSize=12)
ylabel('Global ANEES',FontSize=12)
%ylim([10^-3 10.5])
xlim([10^-4 100])
%set(gca, 'YTick', [0.001 0.01 0.1 1 10 100]);
set(gca, 'XTick', [0.0001 0.001 0.01 0.1 1 10 100]);
...
nexttile
hold on
%title("NCI", 'FontWeight', 'normal')
h1_2=plot(10.^scale, NCI_EKF_2, '-o', 'DisplayName', "EKF", 'Color', '#0072BD','LineWidth',1);
h1_1=plot(10.^scale, NCI_EKF_1, '--o', 'DisplayName', "EKF", 'Color', '#0072BD','LineWidth',1);
h2_2=plot(10.^scale, NCI_EKF2_2, '-s', 'DisplayName', "EKF2", 'Color', "#D95319",'LineWidth',1);
h2_1=plot(10.^scale, NCI_EKF2_1, '--s', 'DisplayName', "EKF2", 'Color', "#D95319",'LineWidth',1);
h3_2=plot(10.^scale, NCI_UKF_2, '-^', 'DisplayName', "UKF", 'Color', "#EDB120",'LineWidth',1);
h3_1=plot(10.^scale, NCI_UKF_1, '--^', 'DisplayName', "UKF", 'Color', "#EDB120",'LineWidth',1);
h4_2=plot(10.^scale, NCI_CKF_2, '-x', 'DisplayName', "CKF", 'Color', "#7E2F8E",'LineWidth',1);
h4_1=plot(10.^scale, NCI_CKF_1, '--x', 'DisplayName', "CKF", 'Color', "#7E2F8E",'LineWidth',1);
h5_1=plot(10.^scale, NCI_IEKF_1, '--d', 'DisplayName', "IEKF", 'Color', "#4DBEEE",'LineWidth',1);
h1_1=plot(nan, nan, 'o', 'Color', '#0072BD', 'DisplayName', 'EKF','LineWidth',1);
h2_1=plot(nan, nan, 's', 'Color', "#D95319", 'DisplayName', 'EKF2','LineWidth',1);
h3_1=plot(nan, nan, '^', 'Color', "#EDB120", 'DisplayName', 'UKF','LineWidth',1);
h4_1=plot(nan, nan, 'x', 'Color', "#7E2F8E", 'DisplayName', 'CKF','LineWidth',1);
...
ylabel('Global NCI',FontSize=12)
xlabel('Measurement standard deviations (m)',FontSize=12)
ylim([-20 80])
xlim([10^-4 100])
set(gca, 'YTick', [-20 0 20 40 60 80]);
set(gca, 'XTick', [0.0001 0.001 0.01 0.1 1 10 100]);
leg=legend([h1_1 h2_1 h3_1 h4_1 h5_1], 'Location','northeast','NumColumns',2,FontSize=11);
title(leg,'Line colors')
grid on
exportgraphics(f2,'3D-tracking-ANEES-NCI.png','Resolution',900)

%%
f3=figure('Position',[100 100 500 450]);
hold on
h1_1=plot(10.^scale, xerrorplotEKF_1, '--o', 'DisplayName', "EKF (old)", 'Color', '#0072BD','LineWidth',1);
h2_1=plot(10.^scale, xerrorplotEKF2_1, '--s', 'DisplayName', "EKF2 (old)", 'Color', "#D95319",'LineWidth',1);
h3_1=plot(10.^scale, xerrorplotUKF_1, '--^', 'DisplayName', "UKF (old)", 'Color', "#EDB120",'LineWidth',1);
h4_1=plot(10.^scale, xerrorplotCKF_1, '--x', 'DisplayName', "CKF (old)", 'Color', "#7E2F8E",'LineWidth',1);
h5_1=plot(10.^scale, xerrorplotIEKF_1, '--d', 'DisplayName', "IEKF (old)", 'Color', "#4DBEEE",'LineWidth',1);

h1_2=plot(10.^scale, xerrorplotEKF_2, '-o', 'DisplayName', "EKF (new)", 'Color', '#0072BD','LineWidth',1);
h2_2=plot(10.^scale, xerrorplotEKF2_2, '-s', 'DisplayName', "EKF2 (new)", 'Color', "#D95319",'LineWidth',1);
h3_2=plot(10.^scale, xerrorplotUKF_2, '-^', 'DisplayName', "UKF (new)", 'Color', "#EDB120",'LineWidth',1);
h4_2=plot(10.^scale, xerrorplotCKF_2, '-x', 'DisplayName', "CKF (new)", 'Color', "#7E2F8E",'LineWidth',1);
set(gca, 'XScale', 'log', 'YScale', 'log', 'XTickLabel', [],'FontSize', 12)
xlabel('Measurement standard deviations (m)',FontSize=12)
ylabel('Estimated standard deviation of the first state (m)',FontSize=12)
ylim([10^-3 10.5])
xlim([10^-4 100])
set(gca, 'YTick', [0.001 0.01 0.1 1 10 100]);
set(gca, 'XTick', [0.0001 0.001 0.01 0.1 1 10]);

leg=legend([h1_1 h2_1 h3_1 h4_1 h5_1 h1_2 h2_2 h3_2 h4_2], 'Location','southeast','NumColumns',2,FontSize=11);
grid on

exportgraphics(f3,'3D-tracking-error.png','Resolution',900)
function [time, x_true, x_RMSE, p_sensor, Runtime, x_error_self_est, ANEES, NCI,ANEES_ideal] = simulation(improvement,magnitude,M,KFtype)
rng(123);
...
ANEES_ideal=0;
NCI=0;
err_storage=NaN(6,M,N);
square_error_storage=NaN(M,N);
%% true trajectory
...
%                 end
        ...
        P_diag(:,k) = diag(P);
        err=x_est(:,k) - x_true(:,k);
        ANEES=ANEES+err'/P*err/N/M/6;
        err_storage(:,m,k-1)=err;
        square_error_storage(m,k-1)=err'/P*err;
    end
...
% Calculate NCI and ideal ANEES
for k=1:N
    Sigma=err_storage(:,:,k)*err_storage(:,:,k)' / M;
    for m=1:M
        ideal_error=err_storage(:,m,k)'/Sigma*err_storage(:,m,k);
        NCInow=10*log10(square_error_storage(m,k)/ideal_error);
        NCI=NCI+NCInow/M/N;
        ANEES_ideal=ANEES_ideal+err'/Sigma*err/M/N/6;
    end
end
